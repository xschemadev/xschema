...
| ----- | ------ | ------ | ------- | ----------- | -------- |
| draft2019-09 | 1029 | 27 | 0 | 178 | 97.4% |
...
![draft2019-09](https://img.shields.io/badge/draft2019-09%20compliance-97.4%25-brightgreen)
...
- **Recursive references between schemas**
  - Test: invalid tree
  - Expected: `invalid`, Got: `error: bundling error: failed to resolve internal refs for compliance://draft6/ref/group_12: recursive local $ref "#/$defs/node" is not supported`
- **Recursive references between schemas**
  - Test: valid tree
  - Expected: `valid`, Got: `error: bundling error: failed to resolve internal refs for compliance://draft6/ref/group_12: recursive local $ref "#/$defs/node" is not supported`
- **naive replacement of $ref with its destination is not correct**
  - Test: match the enum exactly
  - Expected: `valid`, Got: `false`
- **refs with relative uris and defs**
