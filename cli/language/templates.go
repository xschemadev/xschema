...
// TypeScript template - uses @xschema/runtime for API
...
{{- end}}
{{.Imports}}
import { createXSchema } from '@xschema/runtime'
{{range .Schemas}}
...
{{.Imports}}
from xschema_runtime import XSchemaBase, XSchemaAdapter
{{range .Schemas}}
{{.Code}}
{{end}}
