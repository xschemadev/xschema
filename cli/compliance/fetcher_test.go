...
func TestLocalhostFetcher_FetchesLocalFile(t *testing.T) {
	...
	data, err := fetcher.Fetch("http://localhost:1234/integer.json")
	if err != nil {
...
func TestLocalhostFetcher_FetchesSubdirectoryFile(t *testing.T) {
	...
	fetcher := NewLocalhostFetcher(remotesDir)
	data, err := fetcher.Fetch("http://localhost:1234/subdir/schema.json")
	if err != nil {
		t.Fatalf("Fetch() error = %v", err)
	}
...
func TestLocalhostFetcher_FileNotFound(t *testing.T) {
	...
	_, err := fetcher.Fetch("http://localhost:1234/nonexistent.json")
	if err == nil {
...
func TestLocalhostFetcher_StripsQueryParams(t *testing.T) {
	...
	data, err := fetcher.Fetch("http://localhost:1234/schema.json?foo=bar&baz=qux")
	if err != nil {
		t.Fatalf("Fetch() error = %v", err)
	}
