...
describe("discoverAdapters", () => {
	...
	test("errors on duplicate ref", () => {
		...
		expect(() => discoverAdapters(adaptersDir)).toThrow("duplicate adapter ref");
	});
...
describe("generateSchema", () => {
	const tsLang: LanguageInfo = { name: "typescript", adapters: ["@xschemadev/zod"] };
	...
	test("adapter enum contains all adapters (sorted)", () => {
		const lang: LanguageInfo = {
			name: "typescript",
			adapters: ["@xschemadev/zod", "@xschemadev/valibot", "@xschemadev/arktype"],
		};
