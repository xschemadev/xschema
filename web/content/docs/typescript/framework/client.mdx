...
- [Configuration reference](/docs/typescript/framework/configuration) - config file options
- [Compare adapters](/docs/typescript/adapters) - choose the right validator
